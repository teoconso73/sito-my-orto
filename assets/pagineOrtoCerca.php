...
<html lang="en">
  <head>
    ...
    <link href="assets/css/style-responsive.css" rel="stylesheet">
	   <style>
	   .filter-table .quick {  margin-left: 0.5em; font-size: 0.5em; text-decoration: none; }
.fitler-table .quick:hover { text-decoration: underline; }
  ...
  <body onLoad="tID = setTimeout('executeTimer()',5000)" onMouseMove="resetTimer()">
            ...
            echo '</h3></a>';
             ?>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                           <li><a  href="orto1prova.php">orto1Prova</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row"></div>  
 <div>                
<table style="margin-top:10px; text-align: center;width:auto; height:auto;border: 1.7px solid;color: black;"> 
<tr style="font-weight:bold"><td>NOME</td><td>FRUTTO</td><td>FIORI</td><td>FOGLIE</td><td>DIMENSIONE(cm)</td><td>TERRENO</td><td>IRRIGAZIONE</td></tr>
<?php 
...
$query = mysql_query("select *from tabpiante where ID_piante in(select ID_piante from utenti_piante where ID_utente=$utenteAttuale)"); 
